...
export default function Nav() {
  ...
  return (
    <>
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-[#e53935]/20 bg-white/60 backdrop-blur-2xl shadow-[0_2px_20px_rgba(229,57,53,0.15)]">
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <div className="md:hidden border-t border-[#e53935]/15 bg-white/80 backdrop-blur-xl px-4 py-4 flex flex-col gap-3">
            {links.map(l => (
              <Link
                key={l.href}
                href={l.href}
