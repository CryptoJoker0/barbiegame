...
ctx.fillStyle="#ffd34d";ctx.font="900 18px Arial";ctx.textAlign="center";ctx.fillText("BARBIEFUN • BARBIEBEAST ARENA",500,45);drawFighter(game.player);drawFighter(game.opponent)}
